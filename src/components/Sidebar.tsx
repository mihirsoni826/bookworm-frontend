    ...
    return (
        <div className="h-screen w-16 bg-midnight-indigo text-white flex flex-col items-center">
            ...
            <div className="w-full flex flex-col flex-1 items-center justify-center bg-midnight-indigo pb-20">
                <div className="cursor-pointer w-full flex flex-col items-center justify-center hover:bg-gradient-to-b from-b1 to-b2 hover:w-20 hover:rounded-r-lg hover:shadow-[0px_5px_15px_0px_rgba(61, 76, 108, 1)]">
                    ...
                    <div className="w-1/4 border-b pt-4 hover:invisible" />
                </div>
                <hr />
                <div className="cursor-pointer w-full flex flex-col items-center justify-center hover:bg-gradient-to-b from-b1 to-b2 hover:w-20 hover:rounded-r-lg hover:shadow-[0px_5px_15px_0px_rgba(61, 76, 108, 1)]">
                    <a href="#" className="pt-6 pb-2">
